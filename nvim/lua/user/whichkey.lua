...
local leader_normal_mappings = {
	...
	l = {
		...
		K = { "<cmd>lua vim.diagnostic.open_float()<cr>", "Show the diagnostics in pop window" },
...
-- hop.vim key mapping
local hop_mapping = {
	s = { "<cmd>HopWord<cr>", "hop around by highlighting words" },
	S = { "<cmd>HopChar2<cr>", "type a bigram (two keys) and hop to any occurrence of that bigram in the document" },
	m = { "<cmd>HopChar1<cr>", "type a single key and hop to any occurrence of that key in the document" },
